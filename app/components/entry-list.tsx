...
export interface EntryListProps {
  ...
  /** Build filter for a given cursor (0 = first page, otherwise entry ID for cursor-based pagination) */
  buildFilter: (cursor: number) => EntryFilter
}
...
export function EntryList({
  ...
  emptySubtitle = "Nothing to show here yet.",
  parent,
  buildFilter,
}: EntryListProps) {
  const pageSize = 20
